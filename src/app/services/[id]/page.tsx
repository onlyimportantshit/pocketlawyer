...
import { 
  CheckCircle2, FileText, Gavel, Stethoscope, Landmark, 
  FileDigit, Building, CarFront, Briefcase, FileCheck
} from "lucide-react";
...
const SERVICES_DATA: Record<string, any> = {
  ...
  "insurance": {
    ...
    desc: "Recover your rightful claim from insurance companies for health or motor disputes.",
  ...
  "police": {
    ...
    desc: "Expert drafting and filing of police complaints for criminal matters or harassment.",
    docs: ["Identity Proof (Aadhar/PAN)", "Evidence Logs", "Incident Summary"],
  ...
  "ipo": {
    ...
    desc: "Expert guidance for listing your private company on the stock exchange.",
    docs: ["Audit Reports", "Incorporation Certificate", "Director KYC"],
